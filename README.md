...
# Brennerlec road traffic events component

[![REUSE Compliance](https://github.com/noi-techpark/webcomp-traffic-events/actions/workflows/reuse.yml/badge.svg)](https://github.com/noi-techpark/odh-docs/wiki/REUSE#badges)
[![CI/CD](https://github.com/noi-techpark/webcomp-traffic-events/actions/workflows/main.yml/badge.svg)](https://github.com/noi-techpark/webcomp-traffic-events/actions/workflows/main.yml)
[![REUSE status](https://api.reuse.software/badge/github.com/noi-techpark/webcomp-traffic-events)](https://api.reuse.software/info/github.com/noi-techpark/webcomp-traffic-events)

A responsive webcomponent for showing traffic events on Brennerlec A22 road.

- [Brennerlec road traffic events component](#brennerlec-road-traffic-events-component)
  - [Usage](#usage)
...
```html
<script type="module" src="./noi-a22-road-events.esm.js"></script>
```

Define the web component like this:

```html
  <noi-a22-road-events></noi-a22-road-events>
```
...
noi-a22-road-events.dark-mode::part(panel) {
...
```bash
git clone https://github.com/noi-techpark/webcomp-traffic-events.git
```

Change directory:

```bash
cd webcomp-traffic-events/
```
